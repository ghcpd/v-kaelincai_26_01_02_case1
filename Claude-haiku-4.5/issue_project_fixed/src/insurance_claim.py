...
class ClaimCalculator:
    ...
    - Boundary condition fixed: Loss amount exactly 2000 uses correct deductible
    - Driving years bonus calculation properly applied
    """
    ...
    def _calculate_deductible(self, loss_amount: float) -> float:
        ...
        FIXED: Boundary condition at exactly 2000 is now correct.
        ...
        Returns:
            Deductible amount
        """
        # FIX: Changed from loss_amount < 2000 to loss_amount <= 2000
        # This correctly includes the boundary case where loss_amount = 2000
        if loss_amount <= 2000:
            return 500.0
